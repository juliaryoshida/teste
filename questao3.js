...
console.log(`Menor valor de faturamento ocorrido em um dia do mês(dias sem faturamento, como finais de semana e feriados, foram ignorados.): ${menorFaturamento.toFixed(2)}`);
